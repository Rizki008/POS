@extends('layouts.app')
@section('content_title', 'Detail Laporan')
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <p class="m-0">Tanggal Transaksi : <strong>{{ $data->tanggal_transaksi }}</strong></p>
            ...
            <p class="m-0">Total Bayar : <strong>Rp. {{ number_format($data->total_harga) }}</strong></p>
