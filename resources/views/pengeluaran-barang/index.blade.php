@extends('layouts.app')
@section('content_title', 'Barang Keluar')
@section('content')
    <div class="card">
            ...
            <div class="card-body">
                <div class="d-flex">
                    ...
                    <div style="padding-top: 32px">
                        <button type="button" class="btn btn-dark" id="btn-add">Tambah Produk</button>
                    </div>
                </div>
            </div>
    </div>
        ...
        <div class="col-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <div>
                        <button type="submit" class="btn btn-primary w-100 mt-2">Simpan Barang Keluar</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#btn-add').on("click", function() {
                ...
                if (!selectedId || !qty) {
                    alert('Harap pilih produk dan tetnukan jumlahnya');
                    return;
                }
            ...
            $("#form-pengeluaran-barang").on("submit", function() {
                ...
                $("#table-produk tbody tr").each(function(index, row) {
                    ...
                    $("#data-hidden").append(inputProduk).append(inputQty).append(inputProdukId)
                        .append(inputHargaJual)
                        .append(inputSubTotal);
                })
            });
