...
use App\Http\Controllers\PenerimaanBarangControllers;
...
Route::prefix('get-data')->as('get-data.')->group(function(){
    ...
    Route::prefix('master-data')->as('master-data.')->group(function(){
        ...
        Route::prefix('produk')->as('product.')->controller(ProductController::class)->group(function(){
            Route::get('/','index')->name('index');
            Route::post('/', 'store')->name('store');
            Route::delete('/{id}/destroy', 'destroy')->name('destroy');
        });
    ...
    Route::prefix('penerimaan-barang')->as('penerimaan-barang.')->controller(PenerimaanBarangControllers::class)->group(function () {
        Route::get('/', 'index')->name('index');
        Route::post('/', 'store')->name('store');
        Route::delete('/{id}/destroy', 'destroy')->name('destroy');
    });
